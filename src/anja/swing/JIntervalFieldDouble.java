...
implements ChangeListener
{
   ...
   */
   public JIntervalFieldDouble() {
      ...
      this( 0.0, 0.0, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, true,
                                                                        true );
   ...
   */
   public JIntervalFieldDouble(
      ...
      _bound1.addChangeListener( this );
      add( _bound1 );
      _bound2 = new JBoundFieldDouble( right, bounds[1].inclusion[0],
                  left, Double.POSITIVE_INFINITY, 1.0, JBoundFieldDouble.RIGHT,
