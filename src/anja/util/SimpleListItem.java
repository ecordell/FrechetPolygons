...
/**<p>
* Ein einfaches ListItem, das nur einen Wert speichert. Man aendert den Wert
* sowohl mit setKey() als auch mit setValue(). Entsprechend liefern key()
* und value() den selben Wert. An den Listen-Owner wird beim Aendern des
* Wertes immer nur eine Anfrage nach aendern des Schluessels gesendet.
*
* @author Thomas Wolf
* @version 1.0
*/
 ...
 */
 public SimpleListItem(Object key) {
  super();
  _value=key;
 }
 ...
 */
 public Object clone() {
  return new SimpleListItem(_value);
 }
 /**
