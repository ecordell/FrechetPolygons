 ...
 * 
 */
public class ShortestPathLP extends JFrame implements WindowListener,
                ItemListener
{
        // *********************************************************************
        // Private constants
        ...
        private ShortestPathLPEditor _editor;
         ...
         */
        public ShortestPathLP()
        {

                super("The Algorithm by Lee and Preparata");

                _display = new DisplayPanel();
                _extension = new ShortestPathLPExtension();
                lowerPanel = new JPanel();
                _extension.panel = lowerPanel;
                _editor = new ShortestPathLPEditor(_extension);
        ...
        {
                ShortestPathLP this_applet = new ShortestPathLP();
